...
public:
	...
	void AddTexture(const std::string& textureFileName, bool for2D, int type);
	...
	virtual void Motion(){};
	virtual void Draw(int shaderIndx,int cameraIndx,int buffer,bool toClear,bool debugMode,bool flag);
	virtual ~Scene(void);
